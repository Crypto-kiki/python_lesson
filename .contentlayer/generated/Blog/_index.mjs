...
import drf_excuse_2__indexMdx from './DRF_excuse(2)__index.mdx.json' assert { type: 'json' }
...
export const allBlogs = [drf_excuse_1__indexMdx, drf_excuse_2__indexMdx, jupyterNotebook__indexMdx, nextJsBlogWithContentlayer_3__indexMdx]
